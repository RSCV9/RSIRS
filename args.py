...
def get_parser():
    ...
    ###############INFERENCE
    parser.add_argument('--infer_img_path', default='/home/lm/Desktop/RMSIN-main/refer/data/images/rrsisd/JPEGImages/00001.jpg', type=str, help='img')
    parser.add_argument('--infer_language', default='', type=str, help='language')
    parser.add_argument('--infer_img_savepath', default='/home/lm/Desktop/ceshi/00001.png', type=str, help='save')

    ###############
    parser.add_argument('--dataset_path', default='', help='path where to save dataset')
    parser.add_argument('--ov', default=0, type=int, help='ov')
    parser.add_argument('--cross', default='base', type=str, help='cross')
    parser.add_argument('--visualize', default=1, type=int, help='ov')
    parser.add_argument('--inference', default=0, type=int, help='ov')
    ##############
    ...
    parser.add_argument('--resume', default='/media/lm/lmssd1/HY_SEG_FINAL/BASE/BASE.pth', help='resume from checkpoint')
